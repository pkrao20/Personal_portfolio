      ...
      <main className="flex-1 max-w-4xl mx-auto w-full px-6 pt-28 pb-16">
        ...
        {blogs.length === 0 ? (
          <div className="rounded-xl border border-black/8 border-dashed p-16 text-center">
            <p className="text-[#5a5775] text-sm">Posts coming soon.</p>
          </div>
        ) : (
            ...
            {blogs.map((post) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                  ...
                  <span className="text-xs text-[#5a5775] shrink-0 pt-1">
                ...
                <p className="text-sm text-[#2d2b45] mb-4 leading-relaxed">{post.excerpt}</p>
                <div className="flex items-center justify-between">
                  <div className="flex flex-wrap gap-2">
                    {post.tags.map((tag) => (
                      <span
                        key={tag}
                        className="inline-flex items-center gap-1 text-xs px-2 py-0.5 rounded-full bg-black/8 text-[#2d2b45] border border-black/10"
                      >
                        <Tag size={10} />
                        {tag}
                      </span>
                  ...
                  <div className="flex items-center gap-3 text-xs text-[#6b6888] shrink-0">
                    ...
                    <ArrowRight
                      size={14}
                      className="text-[#6b6888] group-hover:text-indigo-600 group-hover:translate-x-0.5 transition-all"
                    />
                  </div>
                </div>
              </Link>
